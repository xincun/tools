...
var strTopRightBlockContent = 
    ...
    '<p><img src="images/uebox_sm.gif" alt="UltraEdit" border="0" class="uebox" />注册费只是: <span class="price" id="ueNewPrice">$59.95</span></p>'+ 
    '<a href="#" onClick="purchaseLink(\'BuyUE\', langStr); return false;" target="_blank"><p class="buy_button">购买</p></a>'+ 
    '<p class="upgrade_text">升级: <span class="price" id="ueUpgradePrice">$29.95</span></p>'+ 
...
var strBottomRightBlockContent = 
    ...
    '<p><img src="images/ue_uc_box.gif" alt="UltraEdit UltraCompare Bundle" border="0" class="bundlebox" />两者注册费只是: <span class="price" id="ueUcBundleNewPrice">$89.95</span></p>'+ 
...
var rightSideContent =
    '<img src="images/ue_uc_box_big.gif" alt="UltraEdit UltraCompare Bundle Box" border="0" class="ue_uc_box_big" />'+ 
		'<h2>UE/UC Bundle</h2>'+ 
		'<p class="ue_uc_bundle_offer">零售价: <span class="retail_price" id="ueUcBundleRetailPrice">$109.95</span><br />'+ 
			'您的价格: <span class="price" id="ueUcBundleNewPrice">$89.95</span><br />'+ 
    ...
    '<p style="clear: both">UltraEdit/UltraCompare 是一个完全综合的完整文本编辑方案。 购买 UE/UC 方案，省 UC 的 40%!</p>'+     
	  ...
	  '<div class="best_value">最好价格</div>' +
	  	'<div class="register">'+ 
				'<p class="register_text">两者注册 <span class="price" id="ueUcBundleNewPrice">$89.95</span></p>'+ 
				'<a href="#" onClick="purchaseLink(\'BuyUEUCBundle\', langStr); return false;" target="_blank"><p class="buy_button">购买</p></a>'+ 
			'</div>'+ 
			'<div class="upgrade">'+ 
				'<p class="register_text">UE 升级 + UC <span class="price" id="ueUpgradeToUeUcBundlePrice">$59.95</span></p>'+ 
...
var leftSideContent =
    ...
    '<div class="register_upgrade_container">'+ 
    '<div class="register">'+ 
    '<p class="register_text">注册 <span class="price" id="ueNewPrice">$59.95</span></p>'+ 
    '<a href="#" onClick="purchaseLink(\'BuyUE\', langStr); return false;" target="_blank"><p class="buy_button">购买</p></a>'+ 
    '</div>'+ 
    '<div class="upgrade">'+ 
    '<p class="register_text">UE 升级<span class="price" id="ueUpgradePrice">$29.95</span></p>'+ 
...
var upgradeRightSideContent =
    '<img src="images/ue_uc_box_big.gif" alt="UltraEdit UltraCompare Bundle Box" border="0" class="ue_uc_box_big" />'+ 
		'<h2>UE/UC Bundle</h2>'+ 
		'<p class="ue_uc_bundle_offer">零售: <span class="retail_price" id="ueUcBundleRetailPrice">$109.95</span><br />'+ 
			'您付款: <span class="price" id="ueUpgradeToUeUcBundlePrice">$59.95</span><br />'+ 
			'您节省: <span class="you_save" id="ueUCBundleYouSavePercentage">##</span>'+ 
		'</p>'+ 
		'<p style="clear: both">购买升级的同时加购UltraCompare，后者又可以为您节省40%！加起来您一共：节省50 ％的升级，节省40 ％的UltraCompare ，还有一年的免费升级两种产品！</p>'+ 
	  '<div class="register_upgrade_container">'+ 
			'<div class="register" style="height: 70px; background-image: url(images/best_value_arrow.gif); background-position: 100% 50%; background-repeat: no-repeat;">'+ 
				'<p style="padding-top: 23px; padding-left: 23px; font-weight: bold">最佳价值</p>'+ 
			'</div>'+ 
			'<div class="upgrade">'+ 
				'<p class="register_text">UE 升级 + UC <span class="price" id="ueUpgradeToUeUcBundlePrice">$59.95</span></p>'+ 
				'<a href="#" onClick="purchaseLink(\'UpgradeUE2UEUCBundle\', langStr); return false;" target="_blank"><p class="buy_button">升级</p></a>'+ 
...
var upgradeLeftSideContent =
    '<img src="images/uebox_big.gif" alt="UltraEdit Box" border="0" class="uebox_big" />'+ 
    '<h2>UltraEdit</h2>'+ 
    '<p>想了解UltraEdit最新的功能？  <a href="#" onClick="openLink(\'http://www.ultraedit.com/products/ultraedit/new_feature_tour.html\'); return false;" target="_blank">See </a> what\'s new and improved since your last upgrade.</p>'+ 
